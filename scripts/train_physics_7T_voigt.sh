...
CONFIG_PATH="${PROJECT_ROOT}/configs/train_physics_7T_voigt.yaml"
RUN_NAME="MS_180_N2S_GlobalVoigt_BaselineReg_NoTwoHG"
...
{
    echo "[$(date --iso-8601=seconds)] Starting PhysicsConv3D 7T N2S global Voigt"
    ...
    echo "Loss:     masked N2S MSE over 1.8-4.2 ppm"
    echo
} > "${LOG_FILE}"
