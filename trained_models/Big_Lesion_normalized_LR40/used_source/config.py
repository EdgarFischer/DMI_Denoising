...
# ---------------------------------------------------------------------------
GPU_NUMBER = "1"
RUN_NAME   = "Big_Lesion_normalized_LR40"
...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Simulated_Lesion_double_1_normalized_proTLR40", "Simulated_Lesion_double_2_normalized_proTLR40", "Simulated_Lesion_double_3_normalized_proTLR40"]
val_data   = ["Simulated_Lesion_double_4_normalized_proTLR40"]
