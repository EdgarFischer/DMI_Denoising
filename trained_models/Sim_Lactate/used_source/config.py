...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Simulated_Lesion_double_1", "Simulated_Lesion_double_2", "Simulated_Lesion_double_3", "Simulated_Lesion_double_4", "Simulated_Lac_everywhere_1", "Simulated_Lesion_1"]
val_data   = ["Simulated_Lesion_2"]
