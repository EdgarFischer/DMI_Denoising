...
phase_prob = 0.0  # data augmentation probabiliy with random global phase 
...
# ---------------------------------------------------------------------------
GPU_NUMBER = "0"
RUN_NAME   = "Tumor_single_oversampled_no_augment"
...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Tumor_1_normalized_masked", "Tumor_1_normalized_masked", "Tumor_1_normalized_masked", "Tumor_1_normalized_masked","Tumor_1_normalized_masked","Tumor_1_normalized_masked","Tumor_1_normalized_masked","Tumor_1_normalized_masked","Tumor_1_normalized_only_tumor_voxels"]
val_data   = ["Tumor_1_normalized_masked"]
