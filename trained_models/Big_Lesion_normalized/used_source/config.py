...
# ---------------------------------------------------------------------------
GPU_NUMBER = "3"
RUN_NAME   = "Big_Lesion_normalized"
...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Simulated_Lesion_double_1_normalized", "Simulated_Lesion_double_2_normalized", "Simulated_Lesion_double_3_normalized"]
val_data   = ["Simulated_Lesion_double_4_normalized"]
