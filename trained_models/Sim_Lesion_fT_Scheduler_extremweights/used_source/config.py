...
# ---------------------------------------------------------------------------
GPU_NUMBER = "0"
RUN_NAME   = "Sim_Lesion_fT_Scheduler_extremweights"
...
def lact_weight(epoch: int) -> float:
    if epoch < 50: return 60
    elif epoch < 100: return 50
    elif epoch < 150: return 40
    elif epoch < 200: return 30
    elif epoch < 250: return 20
    elif epoch < 300: return 10
