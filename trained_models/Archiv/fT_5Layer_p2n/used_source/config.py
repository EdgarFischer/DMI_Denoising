...
# ---------------------------------------------------------------------------
UNET_DIM     = "2d"                 #  2d  | 3d
TRAIN_METHOD = "p2n"                #  n2v = unet | p2n | ynet  
...
lambda_dc  = 0.0              # Gewicht Data Consistency (MSE gegen inp)
lambda_dcs = 1.0              # Gewicht P2N/DCS; setz höher, wenn Konsistenz stärker zählen soll
...
pretrained_ckpt = "trained_models/fT_5Layer_unet_2Channel/checkpoints/best.pt"
