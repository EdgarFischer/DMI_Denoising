...
if UNET_DIM == '2d':
    ...
    transform_train = StratifiedTransform(num_masked_voxels=8448, window_size=3)
    transform_val   = StratifiedTransform(num_masked_voxels=8448, window_size=3)  # oder ebenfalls StratifiedTransform
