...
# ---------------------------------------------------------------------------
GPU_NUMBER = "0"
RUN_NAME   = "Sim_Lactate_Oversampled"
...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Simulated_Lesion_1", "Simulated_Lesion_2", "Simulated_Lesion_3", "Only_Lesion_data_1", "Only_Lesion_data_2", "Only_Lesion_data_3"]
