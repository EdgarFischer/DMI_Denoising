...
# ---------------------------------------------------------------------------
UNET_DIM     = "2d"                 #  2d  | 3d
TRAIN_METHOD = "n2v"                #  n2v = unet | p2n (auch unet) | ynet (noise 2 void) sup_lowrank
...
pretrained_ckpt = "/workspace/Deuterium_Denosing/trained_models/fT_5Layer_LR8/checkpoints/best_unet_lowrank.pt" # choose path for pretrained model, must match mnodel dimensions
