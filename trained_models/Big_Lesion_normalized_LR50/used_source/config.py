...
# ---------------------------------------------------------------------------
GPU_NUMBER = "2"
RUN_NAME   = "Big_Lesion_normalized_LR50"
...
# ---------------------------------------------------------------------------
seed       = 42
train_data = ["Simulated_Lesion_double_1_normalized_proTLR50", "Simulated_Lesion_double_2_normalized_proTLR50", "Simulated_Lesion_double_3_normalized_proTLR50"]
val_data   = ["Simulated_Lesion_double_4_normalized_proTLR50"]
