...
# ---------------------------------------------------------------------------
UNET_DIM     = "2d"                 #  2d  | 3d
TRAIN_METHOD = "sup_lowrank"                #  n2v = unet | p2n (auch unet) | ynet (noise 2 void)

supervised_to_lowrank = True

# Mapping TRAIN_METHOD/UNET_DIM -> (module, func)
_TRAINER_MAP = {
    ("n2v",        "2d"): ("train.trainer",              "train"),
    ("n2s",        "2d"): ("train.trainer",              "train"),
