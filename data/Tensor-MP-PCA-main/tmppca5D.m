...
folders = { ...
    '../../datasets/Simulated_Lesion_2_normalized', ...
    '../../datasets/Simulated_Lesion_3_normalized', ...
    '../../datasets/Simulated_Lesion_4_normalized', ...
    '../../datasets/Simulated_Lesion_5_normalized', ...
    '../../datasets/Simulated_Lesion_6_normalized', ...
    };
...
for i = 1:numel(folders)
    ...
    % --- Ausgabepfad ---
    output_folder = fullfile(base_path, [folders{i} '_tMPPCA_5D']);
